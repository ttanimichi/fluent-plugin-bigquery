...
module Fluent
  class BigQueryOutput < BufferedOutput
    ...
    def start
      ...
      @client = BigQueryPlugin::BigQueryClient.new(
        project:                @project,
        dataset:                @dataset,
        email:                  @email,
    ...
    def write(chunk)
      ...
      create_table(table) if @auto_create_table && (/Not Found: Table/ =~ error.to_s) # Table Not Found: Auto Create Table
